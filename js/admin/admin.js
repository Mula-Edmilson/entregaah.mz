...
function attachEventListeners() {
    ...
    // --- Listeners da Zona de Perigo e Modal de Confirmação ---
...
async function handleNewDelivery(e) {
    ...
    if (autoAssign) {
        ...
        console.log('A enviar pedido com Atribuição Automática...');
    } else {
        console.log('A enviar pedido com Atribuição Manual...');
    }
